  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Registro de Interrupciones</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid"> 
            <div class="row">
              ...
              <div class="card-header">
                <h3 class="card-title">Ingrese nueva Interrupcion</h3>
                    ...
                    <div class ="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                    <input type="text" class="form-control" id="id_alimentador"hidden>
                        ...
                        <div class ="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="email" name="codigo" disabled>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nivel_tension" disabled >
                                </div>
                            </div>   
                            <div class="col-md-2">
                                <div class="form-group">
                                <label for="estado">Estado</label>
                                <input type="text" class="form-control" id="estado_alimentador" disabled >
                                </div>
                            </div> 
                            <div class="col-md-5">
                                <div class="form-group">
                                    <label for="">Descripción </label>
                                    <textarea class="form-control" id="zona" disabled> </textarea>
                                </div>
                            </div>           
                        </div>
                                ...
                                <div class="row mb-3">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="nombre_suc" name="nombre_suc"disabled>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="apellidos_suc" name="apellidos_suc"disabled>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="email_suc" name="email_suc"disabled>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="celular_suc" name="celular_suc"disabled>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="empresa_suc" name="empresa_suc"disabled>
                                    </div>
                                  </div>
                            ...
                            <!-- /.modal-dialog -->
                              ...
                              <div class="col-md-12">
                                <div class="row mb-3">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                    <input type="text" class="form-control" id="id_supervisorset"hidden>
                                      <label for="nombre">Nombre</label>
                                      <input type="text" class="form-control" id="nombre_sus" name="nombre_sus"disabled>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label for="apellidos">Apellidos</label>
                                      <input type="text" class="form-control" id="apellidos_sus" name="apellidos_sus" disabled>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label for="email">Email</label>
                                      <input type="text" class="form-control" id="email_sus" name="email_sus"disabled>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label for="celular">Celular</label>
                                      <input type="text" class="form-control" id="celular_sus" name="celular_sus" disabled>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label for="empresa">Empresa</label>
                                      <input type="text" class="form-control" id="empresa_sus" name="empresa_sus"disabled>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label for="estado_supervisorcco">Estado</label>
                                      <select class="form-control" id="estado_supervisorset" name="estado_supervisorset"disabled>
                                        <option value="ac">Activo</option>
                                        <option value="in">Inactivo</option>
                                      </select>
                                    </div>
              ...
              <div class= "col-md-12">
                  <div class="row">
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          <?php 
                                          $contador_interrupción=1;
                                          foreach($resultai as $row){
                                            $contador_interrupción++;
                                            $hora_inicio=$row['hora_inicio'];
                                            $hora_fin=$row['hora_fin'];
                                            $duracion =$row['duracion'];
                                            //$duracion=$hora_fin->diff($hora_inicio);
                                            //$nombre= $row[nombre];
                                          ...
                                          <input type="text" class="form-control" value="<?php echo $contador_interrupción;?>" id="nro_interrupcion" >
                                          </div>
                                          </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <script >
                          ...
                          if (parseInt(duracion.split(':')[1]) > 3 || parseInt(duracion.split(':')[0]) > 0) {
                              $('#estado_interrupcion').val('in'); // Cambiar automáticamente
                              alert('Duración mayor a 3 minutos, estado establecido como inactivo.');
                          }
                         });
                        </script>
                      ...
                      <div class="row">
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group">
                                          <label for="potencia_interrumpida">Potencia Interrumpida</label>
                                          <input type="number" class="form-control" id="potencia_interrumpida" step="0.01" min="0" placeholder="Ingrese un valor">
                                        </div>
                                      </div>
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="proteccion" name="proteccion">
                                        </div>
                                      </div>
                        ...
                        <div class="row">
                                  <div class="col-md-3">
                                      ...
                                      <div class="col-md-3">
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="zona_afectada">
                                        </div>
                                      </div>
                                      <div class="col-md-2">
                                        <div class="form-group">
                                          <label for=" ">Estado</label>
                                       <select class="form-control" id="estado_interrupcion" >
                          ...
                          <div class="row">
                                        <div class="col-md-6">
                                        <div class="form-group">
                                          <button type="submit" id="btn_guardar_interrupcion" class="btn btn-primary">Guardar Interrupcion</button>
                                        </div>
                                      </div>
                                      <script> 
                                      $("#btn_guardar_interrupcion").click(function(){
                                        //alert('funciona');
                                        ...
                                        var id_supervisorset = $('#id_supervisorset').val();
                                        ...
                                        if (hora_inicio == "") {
                                          ...
                                          alert('Debe llenar la descripción');
                                            ...
                                            var url = "../app/controllers/interrupciones/create_interrupcion.php";
                                            $.get(url, {
