  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Interrupción nro : <?php echo $nro_interrupcion; ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                              ...
                              <div class="col-md-12">
                                <div class="row mb-3">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label for="apellidos">Apellidos</label>
                                      <input type="text" class="form-control" value ="<?php echo $apellidos_sus;?>" id="apellidos_sus" name="apellidos_sus" disabled>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label for="email">Email</label>
                                      <input type="text" class="form-control" value ="<?php echo $email_sus;?>" id="email_sus" name="email_sus"disabled>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label for="celular">Celular</label>
                                      <input type="text" class="form-control" value ="<?php echo $celular_sus;?>" id="celular_sus" name="celular_sus" disabled>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label for="empresa">Empresa</label>
                                      <input type="text" class="form-control" value ="<?php echo $empresa_sus;?>" id="empresa_sus" name="empresa_sus"disabled>
                                    </div>
                                  </div>
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-6">
                                              <div class="form-group">
                                                  <label for="">Usuario</label>                                                                                                                                                             
                                                  <input type="text" class="form-control" value="<?php echo $email_sesion;?>" id="id_usuario" disabled>
                                              </div>
                                          </div>
                          ...
                          <div class="row">
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group">
                                          ...
                                          <input type="number" class="form-control" value="<?php echo $potencia_interrumpida;?>" id="potencia_interrumpida">
                                        </div>
                                      </div>
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" value="<?php echo $proteccion;?>" id="proteccion" >
                                        </div>
                                      </div>
                        ...
                        <div class="row">
                                  <div class="col-md-3">
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" value="<?php echo $causa;?>" id="causa" name="causa">
                                        </div>
                                      </div>

                                      <div class="col-md-3">
                                        <div class="form-group">
                                          <label for="">Zona afectada</label>
                                      ...
                                      <div class="col-md-2">
                                        <div class="form-group">
                                          ...
                                          <select class="form-control" id="estado_interrupcion" name="estado_supervisorcco" disabled>
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group">
                                          ...
                                          <textarea class="form-control" id="zona" readonly><?php echo $descripcion; ?></textarea>
                                        </div>
                                      </div>
                          </div>
                          <hr>
                          <div class="row">
                                        <div class="col-md-6">
                                        <div class="form-group">
                                        <button class="btn btn-danger" id="btn-eliminar"> <i class="fa fa-trash"></i>Eliminar Interrupción</button>
                                        </div>
                                      </div>
                                  ...
                                  $('#btn-eliminar').click(function(){
                                      ...
                                      function eliminar() {
                                          var url = "../app/controllers/interrupciones/delete_interrupcion.php";
                                          $.get(url, {
