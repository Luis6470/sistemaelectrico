  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Eliminar Alimentadores</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="content">
      <div class="container-fluid"> 
              ...
              <div class="card-header">
                <h3 class="card-title">Seguro de eliminar Alimentador?: <?php echo $codigo;?></h3>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12">
                    <form action="../app/controllers/alimentadores/delete_alimentador.php " method="post">
                    <input type="" name="id_alimentador" value="<?php echo $id_alimentador_get; ?>"hidden> 
                      <div class ="row">
                        <div class="col-md-4">
                      ...
                      <div class="form-group">
                        ...
                        <button class="btn btn-danger"  type="submit" name="eliminar" value="eliminar"><i class="fa fa-trash"></i> Eliminar</button>
                      </div>
                      </form> 
                      </div>
